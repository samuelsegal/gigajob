package com.spazomatic.jobyjob.profile.security;
...
public class SimpleSocialUsersDetailService implements SocialUserDetailsService {
	...
	public SocialUserDetails loadUserByUserId(String userId) throws UsernameNotFoundException, DataAccessException {
		...
		SocialUser user = new SocialUser(userDetails.getUsername(), userDetails.getPassword(), userDetails.getAuthorities());
		return user;
	}
